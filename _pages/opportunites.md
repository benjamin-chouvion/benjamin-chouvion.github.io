...
## Stage Master
- Offre de stage pour l'année 2026 sur un projet :airplane: en collaboration avec l'INRIA Paris
...
Plus de détails [ici](/files/LOCKNES.pdf).
 ...
 - Offre de 18 mois dans le cadre du projet ANR FLEXHALE :airplane:, en collaboration avec l'INRIA (poste basé au CMAP à Paris).
...
- Offre de plusieurs mois (entre 6 et 12) dans le cadre du projet BPI KIWIN :sailboat: 
