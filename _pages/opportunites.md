...
## Stage Master
---
- :airplane: Offre de stage pour l'année 2026 sur un projet en collaboration avec l'INRIA Paris
...
---
- :wind_chime: Offre de 12 mois dans le cadre du projet CARNOT MERS, en collaboration avec Centrale Nantes (poste basé à Nantes).
  > Limitation des Oscillations d’´eoliennes offshore au moyen d’un traCK NES
  
Plus de détails [ici](/files/LOCKNES.pdf).

 - :airplane: Offre de 18 mois dans le cadre du projet ANR FLEXHALE, en collaboration avec l'INRIA (poste basé au CMAP à Paris).
...
- :sailboat: Offre de plusieurs mois (entre 6 et 12) dans le cadre du projet BPI KIWIN 
